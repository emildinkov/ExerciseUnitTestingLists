...
public class MatrixTests
{
    ...
    {
        // Arrange
        List<List<int>> matrixA = new() { new() { -7, -9 }, new() { -6, -5 } };
        List<List<int>> matrixB = new() { new() { -2, -5 }, new() { -3, -4 } };
        List<List<int>> expected = new() { new() { -9, -14 }, new() { -9, -9 } };
    ...
    public void Test_MatrixAddition_ZeroMatrix_ReturnsOriginalMatrix()
    {
        ...
        // Assert
        CollectionAssert.AreEqual(result, matrixA);
    }
}
